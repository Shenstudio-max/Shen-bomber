...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32masanga \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border SHEN STUDIO 
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Telegram: https://t.me/joinchat/HOxWPIplrK7TnMgU\e[0m"
    echo -e "\e[4;32m   YouTube: https://youtube.com/channel/UCE_Qc7mRu7rn0DOvoYGE0hg \e[0m"
    echo " "
...
do
    ...
    clear
    if [ $ch -eq 1 ];then
        $PYTHON asanga.py --sms
        exit
    elif [ $ch -eq 2 ];then
        $PYTHON asanga.py --call
        exit
    elif [ $ch -eq 3 ];then
        $PYTHON asanga.py --mail
        exit
    elif [ $ch -eq 4 ];then
        echo -e "\e[1;34m Downloading Latest Files..."
        rm -f .update
        $PYTHON asanga.py --update
        echo -e "\e[1;34m RUN Shen bomber Again..."
        pause
        exit
    elif [ $ch -eq 5 ];then
        banner
